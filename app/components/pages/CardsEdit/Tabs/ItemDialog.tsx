...
const ItemDialog = ({
  ...
  return (
    ...
    <motion.div
      key="modal"
      className="absolute max-h-200 w-280 z-50 rounded-2xl -translate-1/2 overflow-hidden flex gap-4 flex-col"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      ...
      />
      <img src={activeItem.imageUrl} alt="" className="rounded-2xl" />
